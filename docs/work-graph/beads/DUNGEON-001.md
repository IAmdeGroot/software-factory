...
- [x] `examples/dark-dungeon/project.godot` is a Godot 4 project named Dark Dungeon
- [x] A main 2D scene is set as the run scene
- [x] README documents how to open and run the project in Godot 4
- [x] A test checks the required project files exist
- [x] `.godot/` is gitignored
- [x] Decision log records Godot 4 2D for this example
