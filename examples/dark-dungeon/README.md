...
Three rooms (east seal needs a honed nail), shrine, three enemy types, shard loot, three HP (`DUNGEON-001`–`DUNGEON-012`). Inspired by Hollow Knight exploration, not a Hallownest map.
